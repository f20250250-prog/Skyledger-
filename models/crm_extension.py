...
"""
aviation_erp/models/crm_extension.py
Sprint 4 – CRM & Marketing
Extends crm.lead to track specific routes/flights that a lead is
interested in. When the Pricing Engine lowers a fare, a mail.template
is triggered automatically to send a "Price Drop Alert".
"""
...
class CrmLeadAviationExtension(models.Model):
    ...
    def _cron_check_price_drop_alerts(self):
        ...
        """
        Scheduled action: checks all open leads with tracked routes.
        If current pricing drops below the lead's threshold, fires the mail template.
        """
