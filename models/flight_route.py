...
"""
aviation_erp/models/flight_route.py
Sprint 1 – Core Infrastructure
Defines the static route between two airports including waypoints
and base operational cost that feeds the Smart Pricing Engine.
"""
