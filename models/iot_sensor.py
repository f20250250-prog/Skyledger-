...
"""
aviation_erp/models/iot_sensor.py
Sprint 3 – IoT Integration (Community Edition Compatible)
Wraps sensor concepts with an aviation-specific sensor history model.
Stores timestamped telemetry readings per aircraft and surfaces alerts.
"""
...
class AviationIotSensorReading(models.Model):
    ...
    def simulate_live_feed(self, vehicle_id, schedule_id=None):
        ...
        """
        Generate a batch of simulated sensor readings for an aircraft.
        Returns list of created reading IDs.
        """
