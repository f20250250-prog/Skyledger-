...
"""
aviation_erp/models/flight_schedule.py
Sprint 1 & 3 – Schedule Management + Maintenance Block
Links a route to a specific aircraft (fleet.vehicle) for a given date/time.
Includes:
  - Map View geo fields
  - Maintenance block (Sprint 3)
  - Odometer update on completion (Sprint 3)
  - Timesheet link (Sprint 3)
"""
...
class FlightSchedule(models.Model):
    ...
    def _compute_rasm_casm(self):
        ...
        CASM = Total Operating Cost / Available Seat Miles
        ASM  = Total Seats × Distance (nm)  [1 nm ≈ 1 ASM for simplicity]
        """
    ...
    def _check_aircraft_availability(self):
        ...
        """Prevent double-booking the same aircraft."""
    ...
    def _check_maintenance_block(self):
        ...
        """
        Raise UserError if the aircraft has an open Emergency maintenance request.
        Called before confirming a schedule.
        """
    ...
    def action_complete(self):
        ...
        """Mark as completed and trigger Sprint 3 post-flight logic."""
    ...
    def _post_flight_odometer_update(self):
        ...
        """
        Update the aircraft odometer by the route distance.
        If cumulative mileage exceeds the maintenance threshold,
        auto-create a scheduled maintenance request.
        """
    ...
    def action_view_tickets(self):
        ...
        """ 
        Opened when clicking the 'Tickets' stat button on the flight schedule form.
        """
